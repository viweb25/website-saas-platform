...
interface ContactPageProps {
  ...
  theme?: {
    primaryColor?: string; // Fallback fallback accent color (e.g., custom branding)
  };
}

export default function ContactPage({ data, theme }: ContactPageProps) {
  ...
  // Safe fallback branding colors (Premium Blue/Slate accent defaults)
  const accentColor = theme?.primaryColor || "#0f172a"; 
  const badgeTextColor = theme?.primaryColor || "#2563eb";
  const badgeBgColor = theme?.primaryColor ? `${theme.primaryColor}10` : "#eff6ff";

  return (
    <div className="w-full bg-slate-50/50 min-h-screen text-slate-800 antialiased selection:bg-blue-100">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 md:py-20 lg:py-24">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-start">
          ...
          {/* Left Panel: High-End Info Cards Container */}
          <div className="lg:col-span-5 space-y-6">
            <div className="bg-white rounded-2xl border border-slate-100 p-6 sm:p-8 shadow-[0_4px_20px_-4px_rgba(15,23,42,0.05)]">
              ...
              <p className="text-sm text-slate-500 mb-8 font-medium">
                Reach our Coimbatore headquarters through our direct contact options or working hours.
              </p>
            ...
            {/* Google Map Embedded Frame Section */}
          ...
          {/* Right Panel: Sleek Interaction Intake Form */}
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <div>
                ...
                <textarea
                  ...
                  placeholder="Describe your construction, layout, or engineering blueprints infrastructure details..."
                />
              </div>
              ...
              {status === "success" && (
                <div className="flex items-center gap-2 text-emerald-600 bg-emerald-50 border border-emerald-100 px-4 py-3 rounded-xl text-sm font-semibold mt-3 animate-fadeIn">
                  <span>✓</span>
                  <p>Consultation request submitted successfully!</p>
                </div>
              )}
              {status === "error" && (
                <div className="flex items-center gap-2 text-rose-600 bg-rose-50 border border-rose-100 px-4 py-3 rounded-xl text-sm font-semibold mt-3 animate-fadeIn">
                  <span>✕</span>
